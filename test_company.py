...
_emplForAdd = Employee(id="100",name="name100", salary=16000, birthdate="1975-01-10", department="dep1")
...
class TestCompany(TestCase):
    ...
    def test_get_employees_department(self):
        self.assertEqual([_empl1, _empl2], sorted(list(companyInstance.getEmployeesByDepartment("dep1"))))
        companyInstance.hireEmployee(_emplForAdd)
        self.assertEqual(sorted([_empl1, _empl2, _emplForAdd]), sorted(list(companyInstance.getEmployeesByDepartment("dep1"))))
        companyInstance.fireEmployee(_empl2.id)
        self.assertEqual([_empl1,  _emplForAdd], sorted(list(companyInstance.getEmployeesByDepartment("dep1"))))
    ...
    def test_get_employees_salary(self) :
        ...
        self.assertEqual([], list(companyInstance.getEmployeesBySalary(30000, 40000)))     
